...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  AuthBloc(this.authService) : super(AuthInitial()) {
    ...
    // Auth state changes on app start
    ...
    on<RegisterUserEvent>((event, emit) async {
      print('AuthBloc: RegisterUserEvent - Starting registration');
      emit(AuthLoading());
      try {
        ...
        print('AuthBloc: RegisterUserEvent - Success, emitting Authenticated');
        emit(Authenticated(user));
      } catch (e) {
        print('AuthBloc: RegisterUserEvent - Error - $e');
        emit(AuthFailure(e.toString()));
      }
    });
