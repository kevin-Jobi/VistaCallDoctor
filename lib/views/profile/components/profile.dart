  ...
  Widget _buildBody(BuildContext context) {
    return BlocBuilder<DoctorProfileBloc, DoctorProfileState>(
      builder: (context, state) {
        ...
        final availableDays =
            (availability['availableDays'] as List?)
                ?.whereType<String>()
                .toList() ??
            [];
        final availableTimeSlots =
            (availability['availableTimeSlots'] as Map?)?.map(
              (key, value) => MapEntry(
                key.toString(),
        ...
        final initialAvailabilityState = AvailabilityState(
...
Widget _buildAvailabilitySection(
  ...
  // ✅ Ensure a single bloc instance
  final availabilityBloc = AvailabilityBloc()
    ..emit(initialAvailabilityState); // Start with preloaded state
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () {
                  // ✅ Navigate cleanly using same bloc
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                    ...
                    // Refresh doctor profile when returning
