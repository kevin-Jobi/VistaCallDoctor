...
// import 'package:flutter_rating_bar/flutter_rating_bar.dart'; // Added for star ratings
...
//               _buildQuickStats(averageRating, numRatings),
...
//   Widget _buildQuickStats(double averageRating, int numRatings) {
//     return Container(
//       padding: const EdgeInsets.all(20),
//       decoration: BoxDecoration(
//         color: Colors.white,
...
//               title: 'Total\nAppointments',
//               value: '156', // TODO: Fetch dynamically if needed
...
//               icon: Icons.people,
//               title: 'Total\nPatients',
//               value: '89', // TODO: Fetch dynamically if needed
...
//     required dynamic icon, // Changed to dynamic to support RatingBarIndicator
...
//               : icon, // Support RatingBarIndicator
//         ),
...
class DoctorProfileScreen extends StatelessWidget {
  ...
  Widget _buildStatItem({
    required dynamic icon, // Supports IconData or Widget
    required String title,
    required String value,
    required Color color,
  }) {
      ...
      children: [
        Container(
          ...
          child: icon is IconData
              ...
              : icon, // Use directly if it's a Widget (e.g., RatingBarIndicator)
        ),
        const SizedBox(height: 8),
        Text(
          value,
