...
//                               //   onTap: () => context.read<CertificateBloc>().add(
//                               //     CaptureImage(),
//                               //   ),
//                               // ),

//                               // In your GestureDetector for image capture:
...
//                               //     radius: 50,
//                               //     backgroundColor: Colors.grey,
//                               //     child: state.certificatePath != null
//                               //         ? ClipOval(
//                               //             child: Image.file(
...
//                         //       OutlinedButton(
//                         //         onPressed: () {
//                         //           certificateBloc.add(ClearCertificate());
//                         //           // certificateBloc.emit(state.copyWith(certificatePath: null));
//                         //         },
...
//   Widget _buildAvatarChild(state) {
//     if (state.certificatePath != null) {
//       return ClipOval(
//         child: Image.file(
//           File(state.certificatePath!),
...
//                       ),
//                       onTap: () =>
//                           context.read<CertificateBloc>().add(CaptureImage()),
//                     ),
//                   ),
//                   const Spacer(),
